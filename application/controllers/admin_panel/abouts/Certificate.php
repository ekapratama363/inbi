    ...
    public function store()
    {
        ...
        if ($this->form_validation->run() == FALSE){
            ...
            if (!$filename) {
                ...
                redirect(base_url("admin_panel/abouts/certificate/create"));
    ...
    public function update()
    {
        ...
        if ($this->form_validation->run() == FALSE){
            ...
            if(!$filename) {
                ...
                redirect(base_url("admin_panel/abouts/certificate/index"));
    ...
    public function datatable()
    {
        ...
        if(sizeof($posts) > 0) {
            ...
            foreach($posts as $key => $value) {        
                ...
                $action = "
                    <a href='".base_url()."admin_panel/abouts/certificate/edit/".$value->id."' 
                    ...
                    <a onclick='".'return confirm("'."delete this item?".'")'."'
                        href='".base_url()."admin_panel/abouts/certificate/delete/".$value->id."' class='btn btn-danger delete-list'>
