            ...
            <div class="container">
                ...
                <div class="container text-center">
                    <div class="section-title-img">
                        <p><?php echo $product_description->description; ?></p>
                    </div>
                </div>
        ...
        <div class="product-area bg-1 pt-110 pb-80">
            <div class="container">
				...
				<?php foreach($product_images as $index => $product) { ?>
                    <a 
                ...
                <div class="tab-content text-center">
					...
					<?php foreach($product_images as $key => $product) { ?>
                                ...
                                <?php if(count($product->prod_cat_details) > 0 ) { ?>
                                    <?php foreach($product->prod_cat_details as $prod) { ?>
                                        <div class="col-md-6 col-lg-4 mb-4">
                                            <div class="item web">
                                                <a href="<?php echo base_url() ?>uploads/product/<?php echo $prod->product_images->image ?>" class="item-wrap" data-fancybox="gal">
                                                <span style="font-size: 16px;"><?php echo $prod->product_images->title ?></span>
                                                <img class="img-fluid" src="<?php echo base_url() ?>uploads/product/<?php echo $prod->product_images->image ?>">
                                                </a>
                                            </div>
                                        </div>
                                    <?php } ?>
