        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="form-group">
                <div class="mb-3">
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="<?php echo base_url() . 'uploads/about/' . $value->image_header ; ?>" 
                            alt="Card image cap">
                        <div class="card-body">
            ...
            <div class="form-group">
              <div class="mb-3">
                <div class="card" style="width: 18rem;">
                  <img class="card-img-top" src="<?php echo base_url() . 'uploads/about/' . $value->image_footer ; ?>" 
                    alt="Card image cap">
                  <div class="card-body">
