<div class="col-md-12 grid-margin stretch-card">
  <div class="card">
    <div class="card-body">
      ...
      <?php echo form_open_multipart($this->uri->segment(1) .'/'. $this->uri->segment(2).'/'. $this->uri->segment(3) . '/update_background'); ?>
            ...
            <div class="form-group">
                <div class="mb-3">
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="<?php echo base_url() . 'uploads/background/' . $value->image ; ?>" 
                            alt="Card image cap">
                        <div class="card-body">
